...
func New(ctx *gin.Context) {
	//添加商品到购物车
	itemForm := form.ShopCartItemForm{}
	...
	invResp, err := global.InventorySrvClient.InvDetail(context.Background(), &proto.GoodsInvInfo{
...
func Update(ctx *gin.Context) {
	...
	itemForm := form.ShopCartItemUpdateForm{}
	if err := ctx.ShouldBindJSON(&itemForm); err != nil {
		api.HandleValidatorError(ctx, err)
		return
	}
